        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          ...
          <div className="md:col-span-4">
            <div className="flex items-start gap-4">
              <div className="h-12 w-12 flex-shrink-0 rounded-xl bg-gradient-to-br from-emerald-400 to-emerald-600 shadow-md flex items-center justify-center font-extrabold text-black">CK</div>
              <div>
          ...
          <div className="md:col-span-3">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="w-full rounded-md bg-neutral-800/60 border border-white/6 px-3 py-2 text-sm text-gray-100 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                readOnly
              />
              <Link href="/signup" className="inline-flex items-center px-3 py-2 bg-emerald-500 text-black rounded-md text-sm font-medium hover:bg-emerald-600 transition">Subscribe</Link>
            </div>
